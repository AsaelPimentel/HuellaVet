<%@ Page Title="Ventas" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteAdmin.Master" CodeBehind="Ventas.aspx.vb" Inherits="HuellaVet.Ventas" %>
    ...
    <asp:Panel ID="PnlGenerales" runat="server" Visible="false">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="container">
                    <asp:GridView ID="gvProductos" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="DS_ProductosGenerales" GridLines="None" AllowPaging="True" Width="100%" ForeColor="#333333">
